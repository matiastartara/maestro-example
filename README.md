...
- `run_on_cloud` / `get_cloud_run_status` / `list_cloud_devices` — to run on Maestro Cloud instead of locally.

Typical flow when asking Claude to write or fix a test:

1. Start the emulator/device yourself (Claude won't do this for you).
